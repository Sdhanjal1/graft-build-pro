...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Quottr — Speak it. Send it. Get paid." },
      { property: "og:description", content: "The voice-first quoting app for UK trades. Speak the job, send the quote, get paid." },
      { name: "twitter:description", content: "The voice-first quoting app for UK trades. Speak the job, send the quote, get paid." },
